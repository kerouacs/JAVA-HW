...
public class Worksheet2Test {
	...
	// test for exercise1 
		@Test	
		public void test1() {
			Tree T1 = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(8, new Tree<>(6), new Tree<>()));
			Tree<Integer> expected = new Tree<>(-5, new Tree<>(-3, new Tree<>(-1), new Tree<>(-4)), new Tree<>(-8, new Tree<>(-6), new Tree<>()));;
		...
		@Test	
		public void test3() {
			Tree T3 = new Tree<>(-10, new Tree<>(-12, new Tree<>(-20), new Tree<>()), new Tree<>(0, new Tree<>(), new Tree<>(2)));
			Tree<Integer> expected = new Tree<>(10, new Tree<>(12, new Tree<>(20), new Tree<>()), new Tree<>(0, new Tree<>(), new Tree<>(-2)));
		...
		public void test10() {
			Tree T1 = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(8, new Tree<>(6), new Tree<>()));
			List<Integer> expected = new List<Integer>(5,
					new List<Integer>(3, new List<Integer>(1, new List<Integer>(4, new List<Integer>(8,new List<Integer>(6,new List<Integer>()))))));
		...
		public void test15() {
			Tree T1 = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(8, new Tree<>(6), new Tree<>()));
			Tree<Integer> expected = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(8, new Tree<>(), new Tree<>()));
		...
		public void test16() {
			Tree T1 = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(8, new Tree<>(6), new Tree<>()));
			Tree<Integer> expected = new Tree<>(4, new Tree<>(3, new Tree<>(1), new Tree<>()), new Tree<>(8, new Tree<>(6), new Tree<>()));
		...
		public void test17() {
			Tree T1 = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(8, new Tree<>(6), new Tree<>()));
			Tree<Integer> expected = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(6, new Tree<>(), new Tree<>()));
		...
		public void test24() {
			Tree T1 = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(8, new Tree<>(6), new Tree<>()));
			Tree<Integer> expected = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(8, new Tree<>(6), new Tree<>(10)));
		...
		public void test25() {
			Tree T1 = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(8, new Tree<>(6), new Tree<>()));
			Tree<Integer> expected = new Tree<>(5, new Tree<>(3, new Tree<>(1), new Tree<>(4)), new Tree<>(7, new Tree<>(6), new Tree<>(8)));
