 ...
 *  adquately scaled.
 *  To modify it just the Coordinate transformation and I add two methods to get max and min as following
 *  @version 2019-11-17
...
//    private static Function<Double,Double> f;
    ...
    /**
     *   The method approximates the maximal value of the function f in the interval [a,b] 
     ...
     *   @return An approximation of the maximal value of f 
     */
    public static double max(Function<Double,Double> f, int n,
        ...
        return max;
    }//by dividing the interval in n equal parts and evaluating the function at the (n+1) different elements. 
    //It is assumed that b is greater than a.

    /**
     *   The method approximates the minimal value of the function f in the interval [a,b].
     *   @param f The function to be evaluated.
     *   @param n The number of points to be evaluated.
     *   @param a The lowest x-value to be considered.
     *   @param b The highest x-value to be considered.
     *   @return An approximation of the minimal value of f 
     */
    public static double min(Function<Double,Double> f, int n,
        ...
        return min;
    }//by dividing the interval in n equal
